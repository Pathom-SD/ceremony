...
const translations = {
  th: {
    ...
    clearSecret: "รหัสลับ (ถ้า server ตั้งค่าไว้)",
    clearSecretPlaceholder: "ไม่บังคับถ้าไม่ได้ตั้งค่า",
    close: "ปิด",
    customer: "Customer",
    dark: "Dark",
    delivery: "Delivery",
    ...
    finalConfirm: "ยืนยันครั้งสุดท้าย",
    finalConfirmDescription: "กดปุ่มด้านล่างเพื่อลบข้อมูลทั้งหมดอย่างถาวร",
    ...
    clearing: "กำลังลบ…",
    secretRequired: "ต้องใส่รหัสลับ (ตั้งค่า CEREMONY_CLEAR_SECRET บน server)",
  ...
  en: {
    ...
    clearSecret: "Secret (if configured on server)",
    clearSecretPlaceholder: "Optional if not configured",
    close: "Close",
    customer: "Customer",
    dark: "Dark",
    delivery: "Delivery",
    ...
    finalConfirmDescription: "Press the button below to permanently delete all data.",
    ...
    clearing: "Clearing...",
    secretRequired: "Secret required (CEREMONY_CLEAR_SECRET is set on server)",
